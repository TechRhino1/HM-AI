...
class TestIntegrityFixes(unittest.TestCase):
    ...
    def test_india_data_source_flag(self):
        ...
        # `synthetic_anchored` is the honest label for this engine: every bar is
        # generated (it has no live-bar branch), and the anchor may be a live quote.
        self.assertIn(
            d["data_source"],
            ("live", "synthetic_anchored", "synthetic_fallback", "calibrated_feed"),
        )
    ...
    def test_stock_data_source_flag(self):
        ...
        self.assertIn(
            s["data_source"],
            ("mt5_live", "live", "synthetic_anchored", "synthetic_fallback", "calibrated_feed"),
        )
