...
**pytest 1694 passed / 20 deselected** (883 → 887 with `test_history_window_filter.py`, → 914 with
...
`test_broker_symbols.py` (54), → **1694** with `test_parallel_runner.py` (31); 657 when this skill
was written). `tools/`:
