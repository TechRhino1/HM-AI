...
**pytest 2227 passed / 20 deselected** (883 → 887 with `test_history_window_filter.py`, → 914 with
...
`test_hrp_allocator.py` (32), → 1424 with `test_master_confluence.py` (68), → 1541 with
`test_ai_dissector.py` (117), → 1609 with `test_drawdown_guard.py` (68), → **1663** with
...
with `test_market_context.py` (89), → **2227** with `test_market_momentum.py` (91); 657 when this skill
was written). `tools/`:
