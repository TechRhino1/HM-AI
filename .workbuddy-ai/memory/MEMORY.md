...
**pytest 998 passed / 20 deselected** (883 → 887 with `test_history_window_filter.py`, → 914 with
...
branch test, → **998** with `test_measurement_spine.py` (28); 657 when this skill was written). `tools/`:
