...
**pytest 1424 passed / 20 deselected** (883 → 887 with `test_history_window_filter.py`, → 914 with
...
`test_hrp_allocator.py` (32), → **1424** with `test_master_confluence.py` (68); 657 when this skill
was written). `tools/`:
