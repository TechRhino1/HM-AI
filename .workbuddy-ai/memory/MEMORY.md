...
**pytest 1609 passed / 20 deselected** (883 → 887 with `test_history_window_filter.py`, → 914 with
...
`test_ai_dissector.py` (117), → **1609** with `test_drawdown_guard.py` (68); 657 when this skill
was written). `tools/`:
